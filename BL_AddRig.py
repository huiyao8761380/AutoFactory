    ...
    def execute(self, context):
        ...
        if "6AddRig" not in bpy.data.objects:
            if "metarig" not in bpy.data.objects:
                ...
                bpy.ops.transform.rotate(value=-0.5, orient_axis='Y', orient_type='GLOBAL',
                ...
                bpy.ops.transform.translate(value=(0.22, 0, -0.355), orient_type='GLOBAL',
                                            orient_matrix=((1, 0, 0), (0, 1, 0), (0, 0, 1)),
                                            orient_matrix_type='GLOBAL', constraint_axis=(True, False, True),
                ...
                bpy.ops.transform.rotate(value=0.5, orient_axis='Y', orient_type='GLOBAL',
                                         ...
                                         use_proportional_connected=False, use_proportional_projected=False)
                # bpy.ops.transform.translate(value=(0, 0, 0.597073), orient_type='GLOBAL', orient_matrix=((1, 0, 0), (0, 1, 0), (0, 0, 1)), orient_matrix_type='GLOBAL', constraint_axis=(False, False, True), mirror=True, use_proportional_edit=False, proportional_edit_falloff='SMOOTH', proportional_size=1, use_proportional_connected=False, use_proportional_projected=False)
                bpy.ops.transform.translate(value=(-0.059, 0, 0.275), orient_type='GLOBAL',
                                            orient_matrix=((1, 0, 0), (0, 1, 0), (0, 0, 1)),
                                            orient_matrix_type='GLOBAL', constraint_axis=(True, False, True),
                                            mirror=True, use_proportional_edit=False,
                                            proportional_edit_falloff='SMOOTH', proportional_size=1,
                ...
                bpy.ops.transform.resize(value=(4.8, 3.5, 3.5), orient_type='CURSOR',
                                         orient_matrix=((1, 0, 0), (0, 1, 0), (0, 0, 1)), orient_matrix_type='GLOBAL',
...
def register():
    bpy.utils.register_class(AddRig)


def unregister():
    bpy.utils.unregister_class(AddRig)
