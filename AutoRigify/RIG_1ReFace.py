            ...
            for bone in armature.edit_bones:
                if "lips.L" in bone.name:  #
                    ...
                    if bone.head[0] < 2.8635:
                        ...
                        bpy.ops.transform.translate(value=(0.611132, 0.420887, -0.0228424), orient_type='GLOBAL',
                                                    orient_matrix=((1, 0, 0), (0, 1, 0), (0, 0, 1)),
                                                    orient_matrix_type='GLOBAL', mirror=True,
                                                    use_proportional_edit=False, proportional_edit_falloff='SMOOTH',
                                                    proportional_size=0.0220949, use_proportional_connected=False,
            ...
            if "chin.L" in bpy.context.object.data.bones:
                ...
                bpy.ops.armature.duplicate_move(ARMATURE_OT_duplicate={"do_flip_names": False},
                                                TRANSFORM_OT_translate={"value"                 : (
                                                    -0.192229, -1.92778, 3.23282), "orient_type": 'GLOBAL',
                                                    "orient_matrix"                             : (
                                                        (1, 0, 0), (0, 1, 0), (0, 0, 1)),
                                                    "orient_matrix_type"                        : 'GLOBAL',
                                                    "constraint_axis"                           : (
                                                        False, False, False), "mirror"          : True,
                                                    "use_proportional_edit"                     : False,
                                                    "proportional_edit_falloff"                 : 'SMOOTH',
                                                    "proportional_size"                         : 0.0220949,
                ...
                bpy.ops.armature.duplicate_move(ARMATURE_OT_duplicate={"do_flip_names": False},
                                                TRANSFORM_OT_translate={"value"                : (
                                                    -0.168067, -2.13659, 3.4946), "orient_type": 'GLOBAL',
                                                    "orient_matrix"                            : (
                                                        (1, 0, 0), (0, 1, 0), (0, 0, 1)),
                                                    "orient_matrix_type"                       : 'GLOBAL',
                                                    "constraint_axis"                          : (
...
def register():
    bpy.utils.register_class(RigReFace)


def unregister():
    bpy.utils.unregister_class(RigReFace)
